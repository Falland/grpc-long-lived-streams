...
public class ServerControlledStreamObserver<U> implements ControlledStreamObserver<U> {
    ...
    public ServerControlledStreamObserver(ServerCallStreamObserver<U> observer) {
